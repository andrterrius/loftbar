...
export function usePresetOrderConfirmation({ createOrder } = {}) {
  ...
  }, [confirmState, createOrder, submitHooks]);

  const ConfirmModal = useMemo(() => {
    if (!confirmState?.preset) return null;
  ...
  }, [closeConfirm, confirmState, isSubmitting, submit]);

  const SuccessModal = useMemo(() => {
    if (successOrderId === null) return null;
    return (
